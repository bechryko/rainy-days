...
import { GameMusicHandler, GameStatus } from '../models';
...
export class ToolbarComponent {
   ...
   public readonly musicHandler = new GameMusicHandler(computed(() => this.gameStatus().score));
